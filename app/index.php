		...
		<div class="container">
			...
			<nav class="navbar navbar-default">
				<div class="leftHeader col-md-4 col-sm-3 col-xs-6">
					<div class="logo">
						<a href="/"><img style="display:inline;" class="img-responsive" alt="NLSITE" title="NLSITE" src="img/logo.png"></a>
					</div>
				</div>
				<div class="col-md-3 col-sm-3 col-xs-12 phoneHeader">
					<p><a href="tel:+79852452405">+7 985 245 24 05</a></p>
				</div>
				<button class="navbar-toggle col-md-2 col-sm-3 col-xs-2" type="button" data-toggle="collapse" data-target="#navbar-main">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					<ul class="nav navbar-nav navbar-right">
						<li style="padding: 0 10px 0 20px;"><strong style="font-size: 16pt;"><?php echo isset($city['nominative']) ? $city['nominative'] : "Москва"; ?></strong></li>
						<li><a href="http://vk.com/nl_digital" target="_blank"><i class="icon icon-vk"></i></a></li>
						<li><a href="https://www.facebook.com/groups/nl.digital/" target="_blank"><i class="icon icon-fb"></i></a></li>
						<li><a href="http://ok.ru/group/52650818076858" target="_blank"><i class="icon icon-twitter"></i></a></li>
						<li><a href="https://plus.google.com/communities/114102265379721533821" target="_blank"><i class="icon icon-google"></i></a></li>
					</ul>
				</div>
			</nav>
			</div>
			...
			<div class="orderForm">
				<form id="order"  action="mail.php" method="post">
					<fieldset>
						...
						<p><b style="margin-bottom:0;">Закажи сайт сейчас &nbsp;&nbsp;<br /> и получи скидку <span>20%</span></b></p>
							
						<button data-target="#myModal" data-toggle="modal" class="btn btn-primary modalOrder portfBtn">Заказать сайт</button>
					</fieldset>
				</form> 
			</div>        
		</div>
				...
				<ul>
					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://www.bellapotemkina.com/" target="_blank"><img src="img/portfolio/bella_potemkina.png" alt="Бутик Bella Potemkina" title="Бутик Bella Potemkina"></a>
						</div>
					</li>

					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://mgsystem.net/" target="_blank"><img src="img/portfolio/mgs.png" alt="Компания MGSystem" title="Компания MGSystem"></a>
						</div>
					</li>

					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://yugall.ru/" target="_blank"><img src="img/portfolio/yugal.png" alt="Корпорация Южный Альянс" title="Корпорация Южный Альянс"></a>
						</div>
					</li>
						
					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://eurobetonplus.ru/" target="_blank"><img src="img/portfolio/eurobetonplus.png" alt="Компания ЕвробетонПлюс" title="Компания ЕвробетонПлюс"" /></a>
						</div>
					</li>

					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://www.union.ru/" target="_blank"><img src="img/portfolio/union_porte.png" alt="Сайт-каталог Union.ru" title="Сайт-каталог Union.ru"></a>
						</div>
					</li>
							
					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://profstroy.pro/" target="_blank"><img src="img/portfolio/profstroysite.png" alt="Компания ПрофСтрой" title="Компания ПрофСтрой"></a>
						</div>
					</li>
						
					<li>
						<div class="portfolioContainer col-md-3 col-sm-4 col-xs-12">
							<a class="aimg" href="http://imex-broker-moscow.ru/" target="_blank"><img src="img/portfolio/imex.png" alt="Компания ИМЭКС" title="Компания ИМЭКС"></a>
						</div>
					</li>
				</ul>
				<p><button data-target="#myModal" data-toggle="modal" class="btn btn-primary modalOrder portfButton">Заказать сайт</button></p>
				</div>
			</div>
		</div>
</section>
	...
	<div class="container">
		...
		<div class="col-md-3 col-sm-3 col-xs-6 tarif-control">
			<div class="priceWrapper">
				...
				<p><button data-target="#myModal" data-tariff="Лендинг" data-price="50 000 рублей" data-toggle="modal" data-toggle="modal" class="btn btn-primary modalOrder tarifButton">Заказать</button></p>
			</div> 
		</div>
		...
		<div class="col-md-3 col-sm-3 col-xs-6 tarif-control">
			<div class="priceWrapper">
				...
				<p><button data-target="#myModal" data-tariff="Корпоративный сайт" data-price="75 000 рублей" data-toggle="modal" data-toggle="modal" class="btn btn-primary modalOrder tarifButton">Заказать</button></p>
			</div>    
		</div>
		...
		<div class="col-md-3 col-sm-3 col-xs-6 tarif-control">
			<div class="priceWrapper">
				...
				<p><button data-target="#myModal" data-tariff="Интернет-магазин" data-price="100 000 рублей" data-toggle="modal" data-toggle="modal" class="btn btn-primary modalOrder tarifButton">Заказать</button></p>
			</div>    
		</div>
		...
		<div class="col-md-3 col-sm-3 col-xs-6 tarif-control">
			<div class="priceWrapper">
				...
				<p><button data-target="#myModal" data-price="125 000 рублей" data-tariff="Портал" data-toggle="modal" data-toggle="modal" class="btn btn-primary modalOrder tarifButton">Заказать</button></p>
			</div>    
		</div>
		</div>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					...
					<h5>Мостовой Антон Сергеевич - <a target="_blank" href="http://imex-broker-moscow.ru/">imex-broker-moscow.ru</a></h5>
				</div>
				<div class="item">
				...
				<div class="item">
					...
					<h5>Печёнов Николай Борисович - <a target="_blank" href="http://www.doorhan.ru/">doorhan.ru</a></h5>
				</div>
				<div class="item">
					...
					<h5>Зулпукаров Нурбек Исаевич - <a target="_blank" href="http://profstroy.ru/">profstroy.ru</a></h5>
				</div>
			</div>
		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Мы в регионах</a></h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<div class="citycol">  
							...
							<a class="city" target="_blank" href="http://dolgoprudny.nlsite.ru/">Долгопрудный</a><br />
							...
							<a class="city" target="_blank" href="http://zheleznodorozhny.nlsite.ru/">Железнодорожный</a><br />
						...
						<div class="citycol">
							...
							<a class="city" target="_blank" href="http://krasnoarmeysk.nlsite.ru/">Красноармейск</a><br />
							<a class="city" target="_blank" href="http://krasnoznamensk.nlsite.ru/">Краснознаменск</a><br />
							...
							<a class="city" target="_blank" href="http://likinodulovo.nlsite.ru/">Ликино-Дулёво</a><br />
							<a class="city" target="_blank" href="http://lobnya.nlsite.ru/">Лобня</a><br />
						</div>
						<div class="citycol">
							<a class="city" target="_blank" href="http://losinopetrovskiy.nlsite.ru/">Лосино-Петровский</a><br />
							...
							<a class="city" target="_blank" href="http://narofominsk.nlsite.ru/">Наро-Фоминск</a><br />
							...
							<a class="city" target="_blank" href="http://orehovozuevo.nlsite.ru/">Орехово-Зуево</a><br />
							<a class="city" target="_blank" href="http://pavlovskiyposad.nlsite.ru">Павловский Посад</a><br />
						...
						<div class="citycol">
							...
							<a class="city" target="_blank" href="http://sergiev-posad.nlsite.ru/">Сергиев Посад</a><br />
							...
							<a class="city" target="_blank" href="http://starayakupavna.nlsite.ru/">Старая Купавна</a><br />
							...
							<a class="city" target="_blank" href="http://chernogolovka.nlsite.ru/">Черноголовка</a><br />
							...
							<a class="city" target="_blank" href="http://elektrogorsk.nlsite.ru/">Электрогорск</a><br />
							<a class="city" target="_blank" href="http://elektrostal.nlsite.ru/">Электросталь</a><br />
							<a class="city" target="_blank" href="http://elektrougli.nlsite.ru/">Электроугли </a><br />	
						</div>
					</div>
				</div>
			</div>
...
<footer>
		...
		<div class="metrika col-md-3 col-lg-3">
			...
			target="_blank" rel="nofollow"><img src="//informer.yandex.ru/informer/32553710/3_1_FFFFFFFF_EFEFEFFF_0_pageviews"
			style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" onclick="try{Ya.Metrika.informer({i:this,id:32553710,lang:'ru'});return false}catch(e){}"/></a>
			<!-- /Yandex.Metrika informer -->
			...
			(function (d, w, c) {
				(w[c] = w[c] || []).push(function() {
					try {
						w.yaCounter32553710 = new Ya.Metrika({id:32553710,
								clickmap:true});
					} catch(e) { }
				});
			...
			<noscript><div><img src="//mc.yandex.ru/watch/32553710" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
			<!-- /Yandex.Metrika counter -->
		</div>
		<div class='SEO' style="float: right;">
			<p   style="text-align:center;"><a href="http://<?php echo isset($city['next_url']) ? $city['next_url'] : "aprelevka"; ?>.nlsite.ru/" target="_blank">Продвижение сайтов <?php echo isset($city['next']) ? $city['next'] : "в Апрелевке"; ?></a></p>
		</div>
